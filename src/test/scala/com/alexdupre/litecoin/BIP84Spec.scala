...
class BIP84Spec extends FunSuite {
  test("BIP49 reference tests") {
    ...
    assert(key.privateKey.toBase58(Base58.Prefix.SecretKey) == "T5ZCYhLqXu6EJKk2nhjvwsaLH357CisixhLGWpKXEiqWTUtzte6o")
    assert(key.publicKey == PublicKey(hex"02e49c9b9b5d0f127235dc26a0c252814c52fb333d651a946773f59d72c2da9904"))
    ...
    assert(key1.privateKey.toBase58(Base58.Prefix.SecretKey) == "T6LRyVtoN2JxywNyYXwk9KoMpWa34Fjino4upyy9RKs5QQmC8RSr")
    assert(key1.publicKey == PublicKey(hex"021c1750d4a5ad543967b30e9447e50da7a5873e8be133eb25f2ce0ea5638b9d17"))
    ...
    assert(key2.privateKey.toBase58(Base58.Prefix.SecretKey) == "TARZNteayzJqRiXnqKJX3h5zr6H4tx4sXvoZ21pHjAEgNc1g2MWm")
    assert(key2.publicKey == PublicKey(hex"029857513f0fe1dc125f219ffef22098e14c653c4bcb0a2aaeff47b3a252569f1a"))
