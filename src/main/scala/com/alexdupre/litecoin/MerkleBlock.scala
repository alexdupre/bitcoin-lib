...
import com.alexdupre.litecoin.MerkleBlock.topHeight
...
/**
  ...
  */
case class MerkleBlock(version: Long, previousBlockHash: ByteVector, merkleRoot: ByteVector, timestamp: Long, bits: Long, nonce: Long, txCount: Int, hashes: Seq[ByteVector], flags: ByteVector) extends LtcSerializable[MerkleBlock] {
